 ...
 * CustomersPointsTmp
 *
 * @ORM\Table(name="customers_points_tmp")
 * @ORM\Entity(repositoryClass="SharengoCore\Entity\Repository\CustomersPointsTmpRepository")
 */
class CustomersPointsTmp
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="customerspointstmp_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
